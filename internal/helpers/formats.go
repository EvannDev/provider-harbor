...
// IsStringifiedBoolEqual returns false when desired is set
// and doesn't equal *observed.
func IsStringifiedBoolEqual(boolPtr *bool, stringBool *string) bool {
	boolean := ptr.Deref(boolPtr, false)

	return boolPtr == nil ||
		ptr.Deref(stringBool, "") == strconv.FormatBool(boolean)
}
