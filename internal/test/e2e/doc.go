...
// the provider against a live Harbor instance and a real Kubernetes API server.
//
...
//	HARBOR_URL          - base URL of the Harbor instance (e.g. http://localhost:8080)
//	HARBOR_USERNAME     - admin username (typically "admin")
//	HARBOR_PASSWORD     - admin password used to verify state directly via API
//
// The companion ClusterProviderConfig used by the managed resources under
// test is named `e2e` and is created by `cluster/local/harbor_setup.sh`.
package e2e
