...
// Conditioned is the slim contract every Crossplane managed resource already
// satisfies — a Kubernetes object whose status exposes the standard Crossplane
// condition set.
...
// The supplied object is updated in-place with the latest observed state, so
// callers may inspect it directly after the call returns.
...
// SummariseConditions renders a one-line diagnostic of the standard Crossplane
// conditions, suitable for inclusion in a t.Fatalf message.
